        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h1 className="text-4xl lg:text-5xl font-bold text-amber-900 dark:text-gray-200 mb-6 transition-colors duration-300">
                About Jojo Cafe
              </h1>
            ...
            {/* Story */}
            <div className="bg-white dark:bg-[#0f0f0f] p-8 lg:p-12 rounded-2xl mb-16 shadow-xl border border-amber-200 dark:border-[#a13f1f] transition-colors duration-300">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  <h2 className="text-3xl font-bold text-amber-900 dark:text-gray-200 transition-colors duration-300">Our Story</h2>
                  <p className="text-amber-800 dark:text-gray-400 leading-relaxed transition-colors duration-300">
                ...
                <div className="bg-amber-100 dark:bg-[#0f0f0f] p-8 rounded-xl border-2 border-amber-300 dark:border-[#a13f1f] transition-colors duration-300">
                  <Coffee className="h-16 w-16 text-amber-600 dark:text-[#a13f1f] mb-4 transition-colors duration-300" />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-[#0f0f0f] p-6 rounded-xl text-center shadow-lg border border-amber-200 dark:border-[#a13f1f] transition-colors duration-300">
                <Heart className="h-12 w-12 text-amber-600 dark:text-[#a13f1f] mx-auto mb-4 transition-colors duration-300" />
                ...
                <p className="text-amber-700 dark:text-gray-400 text-sm transition-colors duration-300">
                  We pour our heart into every cup we serve
                </p>
              </div>
              
              <div className="bg-white dark:bg-[#0f0f0f] p-6 rounded-xl text-center shadow-lg border border-amber-200 dark:border-[#a13f1f] transition-colors duration-300">
                <Users className="h-12 w-12 text-amber-600 dark:text-[#a13f1f] mx-auto mb-4 transition-colors duration-300" />
                <h3 className="text-xl font-semibold text-amber-900 dark:text-gray-200 mb-2 transition-colors duration-300">Community</h3>
                <p className="text-amber-700 dark:text-gray-400 text-sm transition-colors duration-300">
              ...
              <div className="bg-white dark:bg-[#0f0f0f] p-6 rounded-xl text-center shadow-lg border border-amber-200 dark:border-[#a13f1f] transition-colors duration-300">
                <Coffee className="h-12 w-12 text-amber-600 dark:text-[#a13f1f] mx-auto mb-4 transition-colors duration-300" />
