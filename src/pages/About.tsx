      ...
      <div className="pt-16">
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Story */}
            <div className="bg-white dark:bg-gray-900 p-8 lg:p-12 rounded-2xl mb-16 shadow-xl border border-amber-200 dark:border-orange-600 transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white dark:!bg-gray-900 p-6 rounded-xl text-center shadow-lg border border-amber-200 dark:border-orange-600 transition-colors duration-300">
                <Heart className="h-12 w-12 text-amber-600 dark:text-orange-500 mx-auto mb-4 transition-colors duration-300" />
              ...
              <div className="bg-white dark:!bg-gray-900 p-6 rounded-xl text-center shadow-lg border border-amber-200 dark:border-orange-600 transition-colors duration-300">
                <Users className="h-12 w-12 text-amber-600 dark:text-orange-500 mx-auto mb-4 transition-colors duration-300" />
